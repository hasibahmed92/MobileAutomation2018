...
import java.util.List;
    ...
    public class SellingPage extends Base{

        TouchAction touchAction = new TouchAction(ad);

        @FindBy(className = "android.widget.ImageView")
        public static List<WebElement> burgerBtn = new ArrayList<WebElement>();
        ...
        @FindBy(className = "android.widget.TextView")
        public List<WebElement> searchBoxClassName = new ArrayList<WebElement>();
