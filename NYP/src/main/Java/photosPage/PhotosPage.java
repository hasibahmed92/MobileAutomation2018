...
public class PhotosPage extends Base {
    ...
    public void showPhotos() throws InterruptedException {
        menu.click();
        photos.click();
        sleep(2);
        scrollAndClickByName("Ex-teacher accused of sex with student a no-show in court after joining Army");
        sleep(2);
        String Actual = ad.findElement(By.id("br.com.golmobile.nypost:id/fullscreen_content")).getText();
